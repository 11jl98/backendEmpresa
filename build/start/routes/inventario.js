...
Route_1.default.get('/inventario/relatorio/gerar/:filtro/:texto/:dataInicial/:dataFinal', 'InventarioestoquesController.indexBuscarDadosEstoquePorData');
Route_1.default.get('/inventario/relatorio/gerar/:filtro/:texto/', 'InventarioestoquesController.indexBuscarDadosEstoque');
